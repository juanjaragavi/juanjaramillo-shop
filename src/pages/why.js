    ...
    <Layout disablePaddingBottom>
      ...
      <div className={styles.root}>
        ...
        <Hero
          maxWidth={'900px'}
          image={
            'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-7.webp'
          }
        ...
        <div className={styles.imageContainer}>
          <img
            ...
            src={
              'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-6.webp'
            }
          ></img>
        </div>
          ...
          <div className={styles.content}>
            ...
            <div ref={automatizacionRef}>
              ...
              <img
                alt={'Juan Jaramillo | Experto en IA · Prompt Engineer'}
                src={
                  'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-9.webp'
                }
              ></img>
            </div>
            ...
            <div id={'#decisiones'} ref={decisionesRef}>
              ...
              <img
                alt={'Juan Jaramillo | Experto en IA · Prompt Engineer'}
                src={
                  'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-10.webp'
                }
              ></img>
            </div>
            ...
            <div ref={ahorraRef}>
              ...
              <img
                alt={'Juan Jaramillo | Experto en IA · Prompt Engineer'}
                src={
                  'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-11.webp'
                }
              ></img>
            </div>
            ...
            <div id={'#experiencia'} ref={experienciaRef}>
              ...
              <img
                alt={'Juan Jaramillo | Experto en IA · Prompt Engineer'}
                src={
                  'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-8.webp'
                }
              ></img>
            </div>
            ...
            <div ref={analisisRef}>
              ...
              <img
                alt={'Juan Jaramillo | Experto en IA · Prompt Engineer'}
                src={
                  'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-12.webp'
                }
              ></img>
            </div>
          </div>
        ...
        <div className={styles.imageContainer}>
          <img
            alt={'Juan Jaramillo | Experto en IA · Prompt Engineer'}
            src={
              'https://storage.googleapis.com/media.juanjaramillo.tech/servicios-de-consultoria-tienda-juan-jaramillo-5.webp'
            }
          ></img>
        </div>
      </div>
