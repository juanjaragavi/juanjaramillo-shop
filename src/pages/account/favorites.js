...
const FavoritesPage = (props) => {
  const sampleFavorite1 = {
    color: 'Bronce',
    size: '2',
    img: 'https://media.juanjaramillo.tech/1-tienda-online-de-juan-jaramillo.webp',
  ...
  const sampleFavorite2 = {
    color: 'Plata',
    size: '1',
    img: 'https://media.juanjaramillo.tech/2-tienda-online-de-juan-jaramillo.webp',
    alt: 'Juan Jaramillo | Experto en IA · Prompt Engineer',
  };
  ...
  const sampleFavorite3 = {
    color: 'Oro',
    size: '1',
    img: 'https://media.juanjaramillo.tech/3-tienda-online-de-juan-jaramillo.webp',
    alt: 'Juan Jaramillo | Experto en IA · Prompt Engineer',
  };
  const sampleFavorite4 = {
    color: 'Bronce',
    size: '1',
    img: 'https://media.juanjaramillo.tech/4-tienda-online-de-juan-jaramillo.webp',
    alt: 'Juan Jaramillo | Experto en IA · Prompt Engineer',
  };
