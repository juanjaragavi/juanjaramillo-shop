...
const OrderPage = (props) => {
  ...
  const sampleOrder1 = {
    ...
    items: [
      {
        image: 'https://storage.googleapis.com/media.juanjaramillo.tech/4-tienda-online-de-juan-jaramillo.webp',
      ...
      {
        image: 'https://storage.googleapis.com/media.juanjaramillo.tech/5-tienda-online-de-juan-jaramillo.webp',
